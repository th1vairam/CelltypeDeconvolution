...
knit2synapse::knitToFolderEntity(file = "./ampad_repr_unadj_deconvolution_RFMA_lcpm.Rmd",
                                 parentId = "syn9890608",
                                 entityName = "Cell type frctions - AMPAD - with lcpm signatures")
```
...
CODE = Folder(name = 'Cell type frctions - AMPAD - with lcpm signatures', parentId = parentId)
CODE = synStore(CODE)
