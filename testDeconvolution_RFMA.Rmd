...
knit2synapse::knitToFolderEntity(file = "./testDeconvolution_RFMA.Rmd",
                                 parentId = "syn9890608",
                                 entityName = "Test Deconvolution Methods - RFMA1")
```
...
# From Xue
load(synGet('syn10152436')@filePath)
all.used.ids = c(all.used.ids, 'syn10152436')
...
CODE = Folder(name = 'Test Deconvolution Methods - RFMA1', parentId = parentId)
CODE = synStore(CODE)
